...
const ATHLETES = [
  {
    id: 1,
    name: "Снежкова Алина Ильинична",
    rank: "1 спортивный разряд",
    age: 16,
    region: "г. Лихославль",
    achievements: ["1 место — «Лыжня России»", "Спортсмен Лихославльского МО"],
    stats: { races: 0, podiums: 0, wins: 0 },
    number: "01",
    specialty: "Классический стиль / Свободный стиль",
    emoji: "⭐",
  },
];
